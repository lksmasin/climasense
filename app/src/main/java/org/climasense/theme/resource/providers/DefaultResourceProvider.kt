package org.climasense.theme.resource.providers
...
import org.climasense.common.ui.images.MoonDrawable
import org.climasense.common.ui.images.SunDrawable
import org.climasense.theme.resource.utils.Constants
import org.climasense.theme.resource.utils.XmlHelper
...
class DefaultResourceProvider : ResourceProvider() {
    ...
    companion object {
        fun isDefaultIconProvider(packageName: String): Boolean {
            return packageName == climasense.instance.packageName
        }
