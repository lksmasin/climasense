...
import org.climasense.common.ui.images.pixel.PixelMoonDrawable
import org.climasense.common.ui.images.pixel.PixelSunDrawable
...
class PixelResourcesProvider(defaultProvider: ResourceProvider) : IconPackResourcesProvider(
    climasense.instance,
    climasense.instance.packageName,
    defaultProvider
) {
    ...
    companion object {
        fun isPixelIconProvider(packageName: String): Boolean {
            return packageName == climasense.instance.packageName + ".Pixel"
        }
    }
}
