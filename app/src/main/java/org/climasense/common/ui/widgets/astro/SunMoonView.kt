package org.climasense.common.ui.widgets.astro
...
import org.climasense.common.ui.widgets.DayNightShaderWrapper
...
class SunMoonView @JvmOverloads constructor(
    ...
    private fun ensureShader(
        ...
        mX1ShaderColors[0] = org.climasense.common.utils.ColorUtils.blendColor(lineShadowShader, rootColor)
        mX1ShaderColors[1] = rootColor
        mX2ShaderColors[0] = org.climasense.common.utils.ColorUtils.blendColor(lineShadowShader, mX1ShaderColors[0])
