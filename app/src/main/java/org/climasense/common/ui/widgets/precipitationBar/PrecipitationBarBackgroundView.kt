package org.climasense.common.ui.widgets.precipitationBar
...
class PrecipitationBarBackgroundView(context: Context) : View(context) {
    ...
    val polylineWidth = context.dpToPx(POLYLINE_SIZE_DIP)
    ...
    private fun getLayoutX(xPercent: Float) = if (context.isRtl) {
