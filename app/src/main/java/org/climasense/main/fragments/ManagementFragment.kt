...
import org.climasense.common.ui.composables.NotificationCard
import org.climasense.common.ui.decorations.Material3ListItemDecoration
import org.climasense.common.ui.widgets.Material3Scaffold
import org.climasense.common.ui.widgets.insets.BWCenterAlignedTopAppBar
import org.climasense.common.utils.helpers.SnackbarHelper
import org.climasense.main.MainActivity
import org.climasense.main.MainActivityViewModel
import org.climasense.main.adapters.LocationAdapterAnimWrapper
import org.climasense.main.adapters.location.LocationAdapter
import org.climasense.main.utils.MainThemeColorProvider
import org.climasense.main.widgets.LocationItemTouchCallback
import org.climasense.main.widgets.LocationItemTouchCallback.TouchReactor
import org.climasense.settings.SettingsManager
import org.climasense.settings.preference.composables.RadioButton
            ...
            AlertDialog(
                ...
                text = {
                    LazyColumn(
                        ...
                        items((requireActivity() as MainActivity).sourceManager.getWeatherSources()) { source ->
                            RadioButton(
                ...
                dismissButton = {
                    TextButton(
                        onClick = { uriHandler.openUri("https://github.com/climasense/climasense/blob/main/docs/SOURCES.md") }
                    ) {
                        Text(
