...
class AboutActivity : GeoActivity() {
    ...
    private val aboutAppLinks = arrayOf(
        AboutAppLinkItem(
            ...
            IntentHelper.startWebViewActivity(
                this@AboutActivity,
                "https://github.com/lksmasin/climasense"
            )
        }
    )
    private val contributors: Array<ContributorItem> = arrayOf(
        ContributorItem("LUKYMAS", "https://github.com/lksmasin"),
        ContributorItem("Julien Papasian", "https://github.com/papjul", R.string.about_contribution_papjul),
    ...
    private val translators = arrayOf(
        ...
        TranslatorItem(arrayOf("cs"), "LUKYMAS", "https://github.com/lksmasin"),
